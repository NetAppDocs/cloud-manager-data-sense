...
Before you can scan FSx for ONTAP volumes, link:concept-fsx-aws.html[you must have an FSx working environment with volumes configured^].
...
link:task-creating-fsx-working-environment.html[See how to discover or create the FSx for ONTAP file system in Cloud Manager^].
