...
Before you can scan FSx for ONTAP volumes, https://docs.netapp.com/us-en/cloud-manager-fsx-ontap/start/concept-fsx-aws.html[you must have an FSx working environment with volumes configured^].
...
https://docs.netapp.com/us-en/cloud-manager-fsx-ontap/use/task-creating-fsx-working-environment.html[See how to discover or create the FSx for ONTAP file system in Cloud Manager^].
