...
.. Optionally, check the box to automatically delete files that match the Policy parameters. Learn more about link:task-managing-highlights.html#deleting-source-files[deleting source files using a policy].
