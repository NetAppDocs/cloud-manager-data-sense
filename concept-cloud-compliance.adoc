...
When you deploy Data Sense in the cloud, Cloud Manager deploys the instance in the same subnet as the Connector. link:concept-connectors.html[Learn more about Connectors.^]
...
link:reference-user-roles.html[Learn more about Cloud Manager roles^] and how to link:task-managing-cloud-central-accounts.html#adding-users[add users with specific roles^].
