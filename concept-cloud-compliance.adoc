...
When you deploy Data Sense in the cloud, Cloud Manager deploys the instance in the same subnet as the Connector. https://docs.netapp.com/us-en/cloud-manager-setup-admin/concept-connectors.html[Learn more about Connectors.^]
...
https://docs.netapp.com/us-en/cloud-manager-setup-admin/reference-user-roles.html[Learn more about Cloud Manager roles^] and how to https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-managing-cloud-central-accounts.html#adding-users[add users with specific roles^].
