...
Before you can scan Azure NetApp Files volumes, https://docs.netapp.com/us-en/cloud-manager-azure-netapp-files/task-manage-anf.html[Cloud Manager must be set up to discover the configuration^].
...
https://docs.netapp.com/us-en/cloud-manager-azure-netapp-files/task-manage-anf.html[See how to discover the Azure NetApp Files system in Cloud Manager^].
