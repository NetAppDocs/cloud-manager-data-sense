...
// tag::whats-new[]
== 5 July 2022 (version 1.14.xx)

=== You can "pause" scanning on a repository to temporarily stop scanning certain content
...
If you are moving files from a scanned data source to an NFS share, the maximum amount of files has been increased to 100,000 files.
