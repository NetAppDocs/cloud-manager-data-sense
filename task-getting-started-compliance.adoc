...
* For on-premises ONTAP systems, https://docs.netapp.com/us-en/cloud-manager-ontap-onprem/task-discovering-ontap.html[Cloud Manager must discover the ONTAP clusters^]
...
Your Cloud Volumes ONTAP systems should already be available in the Canvas in Cloud Manager. For on-premises ONTAP systems, you'll need to have https://docs.netapp.com/us-en/cloud-manager-ontap-onprem/task-discovering-ontap.html[Cloud Manager discover these clusters^].
...
. From the Cloud Manager left navigation menu, click *Data Sense* and then select the *Configuration* tab.
+
