...
* Verify that your on-prem Connector software has been upgraded to the newest available version. link:task-managing-connectors.html#upgrading-the-connector-on-prem-without-internet-access[See the Connector upgrade steps^].
