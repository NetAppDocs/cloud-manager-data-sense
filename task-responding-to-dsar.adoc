...
Search for the data subject's full name or known identifier and then download a file list report or DSAR report. You can search by link:task-controlling-private-data.html#types-of-personal-data[any personal information type^].
